...
function rent() {
    console.log("The rental date is: " + rentalDate);
    var person = prompt("Please leave your name and best contact info, and we will contact you personally to confirm your request.");
    if (person == null || person == ""){
        // Do nothing
    } else {
        alert("Thank You for your interest in one of our services, but it looks like something went wrong. Please Contact us at 800-GET-BEST.");
    } 
}
